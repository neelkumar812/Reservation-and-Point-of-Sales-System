...
public abstract class BaseUI {
    ...
    /**
     * Constant for print size for console printing
     */
     ...
     *
     * @return Exit Codes for {@link BaseUI#startMainMenu()} to implement. 0 to loop into the method again,
